...
**المستخدم في**: `sign-up.component.ts` - صفحة إنشاء حساب جديد
...
- `hotels-list.component.ts` - لعرض قائمة الفنادق
...
**المستخدم في**: `rooms.component.ts` - لإدارة حالة الغرف من قبل المشرف
